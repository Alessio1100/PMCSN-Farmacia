...
if __name__ == "__main__":
    ...
    fig = plot_response_time("stats/configuration/Total_outofstock[4,2]Veloce.dat",  # Sostituisci con il path del tuo file
                             None,
                             title="Perdite Per Out Of Stock - Configurazione [4,2]")

    plt.show()

    # Salva il grafico se necessario
    # plt.savefig("response_time_plot.png", dpi=300, bbox_inches='tight')
    # Total_abandon[5,2]Veloce.dat
    # Global_response[5,2]Veloce.dat
    # "Tempo di Risposta - Sistema Configurazione [5,2]"